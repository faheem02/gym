...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name === '' || $duration_days <= 0 || $price === '' || !is_numeric($price)) {
        ...
        header('Location: /gym/plans/index.php?msg=added');
        exit;
    }
}
?>
        ...
        <form method="POST" action="">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="duration_days" class="form-control" placeholder="e.g. 30, 90, 365" min="1" required>
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="form-control" rows="2" placeholder="Short description of this plan..."></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <input type="number" name="day_pass_discount" class="form-control" id="discountInput" min="0" max="100" value="0" onchange="previewDiscount()">
                    </div>
                    <div class="col-md-8">
                        <input type="range" class="form-range" min="0" max="100" step="5" value="0" id="discountRange" oninput="syncDiscount(this.value)">
