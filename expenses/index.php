...
<div class="page-header mb-3">
    ...
    <div class="d-flex flex-wrap align-items-center gap-2">
        <button type="button" onclick="downloadExpenseListPDF();" class="btn btn-primary btn-sm fw-bold" title="Download PDF"><i class="fas fa-file-pdf me-1"></i>Download PDF</button>
        <button type="button" onclick="window.print();" class="btn btn-danger btn-sm fw-bold" title="Print expense list"><i class="fas fa-print me-1"></i>Print</button>
        <a href="categories/" class="btn btn-outline-warning btn-sm fw-bold"><i class="fas fa-tags me-1"></i>Categories</a>
        <a href="add.php" class="btn btn-warning btn-sm fw-bold"><i class="fas fa-plus me-1"></i>Add Expense</a>
    </div>
</div>
...
@media print {
    ...
    .page-header, .row.g-3.mb-4, .card, script { display: none !important; }
...
<script>
function downloadExpenseListPDF() {
