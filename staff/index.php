    ...
    <div class="row g-2 align-items-center">
        <div class="col-md-4 col-lg-4">
            <form method="GET" action="" class="d-flex align-items-center gap-2">
                <input type="text" name="q" value="<?php echo htmlspecialchars($search); ?>" class="form-control" placeholder="Search by name, phone, role...">
                <button class="btn btn-dark btn-sm text-nowrap px-3" type="submit"><i class="fas fa-search me-1"></i>Search</button>
            </form>
        </div>
        <div class="col-md-8 col-lg-8 d-flex flex-wrap align-items-center justify-content-md-end gap-2">
            <button type="button" onclick="downloadStaffListPDF();" class="btn btn-primary fw-bold" title="Download PDF"><i class="fas fa-file-pdf me-1"></i>Download PDF</button>
            <button type="button" onclick="window.print();" class="btn btn-danger fw-bold" title="Print staff list"><i class="fas fa-print me-1"></i>Print</button>
            <a href="salaries.php" class="btn btn-success fw-bold"><i class="fas fa-money-bill-wave me-1"></i>Salaries</a>
...
#printSection .print-table .last-pay { font-size: 8.5px; color: #777777; }
...
function downloadStaffListPDF() {
    ...
    var opt = {
        margin:       [8, 8, 8, 8],
        filename:     'Staff_List_Report.pdf',
